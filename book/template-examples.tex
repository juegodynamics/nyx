...
\begin{figure}[h]
  \centering\includegraphics[scale=0.5]{placeholder.png}
...
% \includemedia[
% addresource=audio/fricative-stridulyngeal.mp3,
% flashvars={
% source=audio/fricative-stridulyngeal.mp3
% &autoPlay=false
% },
% transparent,
% passcontext %show APlayer's right-click menu
% ]{\color{blue}\framebox[0.4\linewidth][c]{Example}}{APlayer.swf}
